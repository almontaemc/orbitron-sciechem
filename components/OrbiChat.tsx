...
function WhatsAppIcon({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        fill="white"
        d="M11.42 9.49c-.19-.09-1.1-.54-1.27-.6-.17-.06-.29-.09-.42.09-.12.18-.48.6-.59.72-.11.12-.22.14-.41.05a5.18 5.18 0 01-1.52-.94 5.74 5.74 0 01-1.05-1.31c-.11-.19-.01-.29.08-.38l.28-.33c.09-.11.12-.19.19-.31.06-.13.03-.24-.02-.33-.05-.09-.42-1.01-.57-1.38-.15-.36-.31-.31-.42-.32H5.3c-.13 0-.33.05-.5.23-.17.18-.65.63-.65 1.55s.67 1.8.76 1.92c.1.13 1.31 2 3.18 2.81.44.19.79.3 1.06.38.45.14.85.12 1.17.07.36-.05 1.1-.45 1.26-.88.16-.43.16-.8.11-.88-.04-.08-.17-.13-.36-.22z"
      />
    </svg>
  );
}
